//
//  ScoresCollectionViewLayout.swift
//  EvenTheScore
//
...
class ScoresCollectionViewLayout: UICollectionViewFlowLayout {
  ...
  override init() {
    ...
    itemSize = CGSize(width: UIScreen.main.bounds.width - (Constants.padding * 2), height: 100)
  }
